...
<body class="reset">
        <div class="mt-5 text-center reset-content">
            <div class="form">
                ...
                <form action="<?php echo site_url('view/password_reset_action'); ?>" class="justify-content-center" method="post" autocomplete="off">
                        <div class="text-left text-light">
                            <label for="">Username</label>
                            <input type="text" class="text-input py-2" name="username"autocomplete="off"  placeholder="username" required>
                            <label for="password">Key</label>
                            <input type="text" class="text-input py-2 " name="key" autocomplete="off" placeholder="key"required>

                            <input type="submit" class="btn btn-primary mt-3 btn-block py-2" value='RESET'>
                        </div>
                    </form>
                <div class="content py-2">
                    <a href="<?php echo site_url('view')?>" class=""><p>Go Back</p></a>
                </div>
