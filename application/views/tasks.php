    ...
    <div class="col-md-12">
        ...
        <div class="table-data__tool">
            ...
            <div class="table-data__tool-right">
                <button class="au-btn au-btn-icon au-btn--green au-btn--small" onclick="location.href='<?php echo site_url('view/tasks/add')?>'">
        ...
        <div class="table-responsive table-responsive-data2">
            ...
            <table class="table table-data2">
                ...
                <?php
                if(isset($allTasks)&&is_array($allTasks)&&count($allTasks)>0) {
                    $itemCount = 0;

                    foreach ($allTasks as $dataRow) {
                        $itemCount+=1;

                        $id=$dataRow->taskId;
                        $taskTitle=$dataRow->taskTitle;
                        $taskProject=$this->Admin_model->getProjects()[0]->projTitle;;
                        ...
                        if(isset($userRoles)){
                            ...
                            if(in_array('45',json_decode($userRoles))){
                                $editUrl=site_url('view/tasks/edit/'.$id);
                            }

                            if(in_array('46',json_decode($userRoles))){
                                $deleteUrl=site_url('view/tasks/delete/'.$id);
