    ...
    <div class="col-md-12">
        ...
        <div class="table-data__tool">
            ...
            <div class="table-data__tool-right">
                <button class="au-btn au-btn-icon au-btn--green au-btn--small" onclick="location.href='<?php echo site_url('view/accounts/add')?>'">
        ...
        <div class="table-responsive table-responsive-data2">
            ...
            <table class="table table-data2">
                ...
                if(isset($allAccounts)&& is_array($allAccounts)&&count($allAccounts)>=0){

                    $itemCount=0;
                    foreach ($allAccounts as $dataRow) {

                        $itemCount+=1;
                        $id = $dataRow->accountId;
                        $accountAmount = $dataRow->accountAmount;
                        $accountDate = $dataRow->accountDate;
                        $accountProject=$this->Admin_model->getProjects()[0]->projTitle;
                        ...
                        if(in_array('57',json_decode($this->userRoles)))
                            $editUrl=site_url('view/accounts/edit/'.$id);

                        if(in_array('58',json_decode($this->userRoles)))
                            $deleteUrl=site_url('view/accounts/delete/'.$id);


                        echo "<tr>";
                        echo "<td>" .$id ."</td>";
                        echo "<td>" .$accountAmount ."</td>";
                        echo "<td>".$accountDate."</td>";
                        echo "<td>".$accountProject."</td>";
                        echo "<td>".$accountModeOfPayment."</td>";
